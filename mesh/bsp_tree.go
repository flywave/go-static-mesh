...
func PerformBoolean(meshA, meshB *Mesh, operation BSPOperation) (*Mesh, error) {
...
func meshToBSPPolygons(mesh *Mesh) BSPPolygons {
...
func bspPolygonsToMesh(polygons BSPPolygons) *Mesh {
	mesh := &Mesh{
		Vertices: []vec3d.T{},
		Indices:  []uint32{},
	}
