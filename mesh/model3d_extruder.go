...
func (e *Model3DExtruder) ExtrudeModelToMesh(mesh *Mesh, model *static.Model3D, terrainMesh interface{}) error {
	if model.Mesh == nil {
...
func (e *Model3DExtruder) ExtrudeModelsToMesh(mesh *Mesh, models []static.Model3D, terrainMesh interface{}) error {
	for i := range models {
...
func (e *Model3DExtruder) ExtrudeModelAtElevation(mesh *Mesh, model *static.Model3D, terrainMesh interface{}, elevation float64) error {
	if model.Mesh == nil {
		return fmt.Errorf("model mesh is nil")
	}
...
func (e *Model3DExtruder) transformModelVertices(vertices []vec3d.T, model *static.Model3D) []vec3d.T {
