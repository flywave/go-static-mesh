...
func (p *MockRasterProvider) GetElevationGrid() *tile.ElevationGrid {
	return p.grid
}

func (p *MockRasterProvider) GetElevationTile(coord [3]int) (*tile.ElevationGrid, error) {
	return p.grid, nil
}

func (p *MockRasterProvider) GetTileData(coord [3]int) (*tile.TileData, error) {
...
func TestBuilderBuildFromRaster(t *testing.T) {
	...
	tinGenerator := mesh.NewTINGenerator()
