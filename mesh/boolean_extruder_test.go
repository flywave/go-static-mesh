...
func TestBooleanExtruderSetOperation(t *testing.T) {
	...
	extruder.SetOperation(BSPOperationSubtraction)
...
func TestExtrudeAndIntersectEmptyMeshes(t *testing.T) {
	meshA := &Mesh{Vertices: []vec3d.T{}, Indices: []uint32{}}
	meshB := &Mesh{Vertices: []vec3d.T{}, Indices: []uint32{}}
