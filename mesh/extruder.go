...
type MeshObject interface {
	...
	ExtrudeToMesh(mesh *Mesh, height float64) error
	ExtrudeToMeshWithResolution(mesh *Mesh, height, resolution float64) error
}
...
func (e *PathExtruder) ExtrudeToMesh(path *draw.Path, mesh *Mesh, height float64) error {
...
func (e *PathExtruder) ExtrudeToMeshWithResolution(path *draw.Path, mesh *Mesh, height float64, options *ExtrudeOptions) error {
...
func (e *AreaExtruder) ExtrudeToMesh(area *draw.Area, mesh *Mesh, height float64) error {
	return e.ExtrudeToMeshWithResolution(area, mesh, height, 1.0)
}

func (e *AreaExtruder) ExtrudeToMeshWithResolution(area *draw.Area, mesh *Mesh, height, resolution float64) error {
